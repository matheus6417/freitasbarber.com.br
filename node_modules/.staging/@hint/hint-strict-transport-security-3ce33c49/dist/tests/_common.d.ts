...
export declare const multipleMaxAgeError: string;
export declare const multipleincludeSubDomainsError: string;
export declare const tooShortErrorDefault: string;
export declare const DelimiterwrongFormatError: string;
export declare const UnitwrongFormatError: string;
export declare const statusServiceError = "Error with getting preload status for https://localhost/.";
export declare const preloadableServiceError = "Error with getting preload eligibility for https://localhost/.";
export declare const problemWithVerificationEndpoint = "Error with getting preload status for https://localhost/. There might be something wrong with the verification endpoint.";
...
export declare const requestJSONAsyncMock: (responseObject: any) => void;
