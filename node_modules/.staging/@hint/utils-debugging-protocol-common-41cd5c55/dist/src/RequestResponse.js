...
class RequestResponse {
    constructor(network, event, overrideInvalidCert) {
        this._hops = [];
    ...
    getResponse(element) {
        if (!this._response) {
            ...
            const normalizedHeaders = normalize_headers_1.normalizeHeaders(headers);
            const that = this;
            ...
            const { charset, mediaType } = content_type_1.getContentTypeData(element, this.originalUrl, normalizedHeaders, rawContent);
